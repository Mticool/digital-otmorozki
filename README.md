...
> 🎁 **Бонусный агент:** папка `03-critic` — дополнительный редактор. В базовой конфигурации не нужен, но можно подключить как 7-го агента для повышенного контроля качества текстов.
